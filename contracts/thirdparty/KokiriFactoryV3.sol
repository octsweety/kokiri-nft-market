...
import "./KokiriFactoryV2.sol";
import "./KokiriMintingStation.sol";

contract KokiriFactoryV3 is Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    KokiriFactoryV2 public bunnyFactoryV2;
    KokiriMintingStation public bunnyMintingStation;
    ...
    constructor(
        KokiriFactoryV2 _bunnyFactoryV2,
        KokiriMintingStation _bunnyMintingStation,
        IERC20 _cakeToken,
        uint256 _tokenPrice,
    ...
    /**
     * @dev Mint NFTs from the KokiriMintingStation contract.
